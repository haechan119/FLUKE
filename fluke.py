...
def please(a,b,c,d):
    dxl_comm_result,dxl_error = packetHandler.write1ByteTxRx(a,b,c,d)
    if dxl_comm_result != COMM_SUCCESS:
        print("%s" % packetHandler.getTxRxResult(dxl_comm_result))
    elif dxl_error != 0:
        print("%s" % packetHandler.getRxPacketError(dxl_error))
...
# Yaw motor
please(portHandler, YAW_ID, ADDR_OPERATING_MODE, EXT_POSITION_CONTROL_MODE)
...
#    print("Operating mode of XL330 changed to velocity control mode.")
# Pitch motor
please(portHandler, PITCH_ID, ADDR_OPERATING_MODE, EXT_POSITION_CONTROL_MODE)
...
# Yaw motor
please(portHandler, YAW_ID, ADDR_TORQUE_ENABLE, TORQUE_ENABLE)
...
#    print("XL330 has been successfully connected")
# Pitch motor
please(portHandler, PITCH_ID, ADDR_TORQUE_ENABLE, TORQUE_ENABLE)
...
# Yaw motor
please(portHandler, YAW_ID, ADDR_VELOCITY_PROFILE, Velocity_Value)
...
#    print("XL330 has been successfully connected")
# Pitch motor
please(portHandler, PITCH_ID, ADDR_VELOCITY_PROFILE, Velocity_Value)
...
while 1:
    ...
    if c == chr(ESC_ASCII_VALUE):
        ...
        please(portHandler, PITCH_ID, ADDR_GOAL_POSITION, MAX_POSITION_VALUE)
        ...
        please(portHandler, YAW_ID, ADDR_GOAL_POSITION, -MAX_POSITION_VALUE)
    ...
    while 1:
        ...
        if kbhit():
            ...
            if c == chr(SPACE_ASCII_VALUE):
                ...
                please(portHandler, dxl_ID, ADDR_GOAL_POSITION, dxl_present_position)
